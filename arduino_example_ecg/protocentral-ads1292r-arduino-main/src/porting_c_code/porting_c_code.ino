//////////////////////////////////////////////////////////////////////////////////////////
//
//   Arduino Library for Shield/Breakout
//
...
void setup()
{
  ...
  Serial.begin(57600);
  ads1292Init(ADS1292_CS_PIN,ADS1292_PWDN_PIN,ADS1292_START_PIN);
...
void loop()
{
  ...
  boolean ret = getAds1292EcgAndRespirationSamples(ADS1292_DRDY_PIN,ADS1292_CS_PIN,&ecgRespirationValues);
  if (ret == true)
  {
